...
# service to its own named queue (matched by the "-Q notification" flag on
# this service's celery command in infra/docker-compose.yml) keeps every
# worker only ever consuming its own tasks.
