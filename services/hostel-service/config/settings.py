"""Django settings for hostel-service.

hostel-service is a stateless resource service: it verifies JWTs issued by
auth-service (via suerp_common) and owns its own hostel database. It has no
...
SPECTACULAR_SETTINGS = {
    "TITLE": "SU-ERP Hostel Service API",
    "DESCRIPTION": "Blocks, rooms, allocations, leave requests, and complaints for SU-ERP.",
    "VERSION": "1.0.0",
